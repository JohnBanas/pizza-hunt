...
request.onsuccess = function (event) {
  ...
  if (navigator.online) {
    //for when the internet is back online, saving the offline created pizzas fx below
    uploadPizza();
  }
};
...
//when internet connection comes back we upload created pizzas from IndexDB to our database
